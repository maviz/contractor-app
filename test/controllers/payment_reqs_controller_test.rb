...
class PaymentReqsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_req" do
    assert_difference("PaymentReq.count") do
      post payment_reqs_url, params: { payment_req: { amount: @payment_req.amount, currency: @payment_req.currency, description: @payment_req.description } }
    end
  ...
  test "should update payment_req" do
    patch payment_req_url(@payment_req), params: { payment_req: { amount: @payment_req.amount, currency: @payment_req.currency, description: @payment_req.description } }
